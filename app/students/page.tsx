...
export default async function StudentsPage() {
  ...
  const [{ data: students }, { data: enrollments }, { data: requests }] = await Promise.all([
  ...
  return <Shell canManage={canManage} students={rows} classes={reference.classes} sections={reference.sections} years={reference.years} requests={(requests||[]) as any[]}/>;
}
